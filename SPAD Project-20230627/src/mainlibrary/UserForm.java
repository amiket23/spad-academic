...
public class UserForm extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String User = (UserName.getText()).replaceAll("[^a-zA-Z0-9]", "");
        if (UsersDao.CheckIfAlready(User)) {
            ...
            JOptionPane.showMessageDialog(UserForm.this, "Email format incorrect!", "Adding new User Error!", JOptionPane.ERROR_MESSAGE);
        } else {
            try {
                User = (UserName.getText()).replaceAll("[^a-zA-Z0-9]", "");
                ...
                if (UsersDao.AddUser(User, UserPass, salt, UserEmail, Date) != 0) {
                ...
                Logger.getLogger(UserForm.class.getName()).log(java.util.logging.Level.SEVERE, null, e);
            }
